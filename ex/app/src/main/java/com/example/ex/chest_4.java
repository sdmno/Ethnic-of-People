...
public class chest_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chest4_image = findViewById(R.id.chest4_image);
        ...
        chest4_rg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.chest4_rb1){
                    ...
                    chest4_image.setImageResource(R.drawable.dumbbell_fly);
                    ...
                    chest4_image.setImageResource(R.drawable.incline_dumbbell_fly);
